...
REM CMD /C node_modules\.bin\uglifyjs "argue2.js" --stats --comments --beautify --compress unsafe=true,hoist_vars=true --define "ARGUEJS_PRODUCTION_READY=true,ARGUEJS_EXPORT_INTERNALS=false"  --output "argue2.production.min.js"
POPD
