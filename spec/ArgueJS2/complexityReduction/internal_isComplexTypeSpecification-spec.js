define(['argue2', 'argue2.testable.min', 'argue2.testable.production.min', 'chai'], function(arguejs2_original, arguejs2_minified, arguejs2_production_minified, chai) {
    ...
    // Tests...
    describe("internal isComplexTypeSpecification", function() {
    ...
    function runTestsForVariant(arguejs2Name, arguejs2) {
        describe("[" + arguejs2Name + "]:", function() {
            ...
            var testCases = [   {typeSpecification: null,                   expectedResult: false},
                                ...
                                {typeSpecification: {a: 1},                 expectedResult: true},
            ...
            it("is a function", function() {
                expect(arguejs2_internals.$.isComplexTypeSpecification).to.be.a("function");
            });
            ...
            function runTestCase(_testCase) {
                ...
                var description =
                        ...
                        " is " + (_testCase.expectedResult ? "" : "not ") + "a complex type specification";

                it(description, function() {
                    var result = arguejs2_internals.$.isComplexTypeSpecification(_testCase.typeSpecification);
