define(['argue2', 'argue2.testable.min', 'argue2.testable.production.min', 'chai'], function(arguejs2_original, arguejs2_minified, arguejs2_production_minified, chai) {
    ...
    // Tests...
    describe("internal isSimpleMandatoryTypeSpecification", function() {
    ...
    function runTestsForVariant(arguejs2Name, arguejs2) {
        describe("[" + arguejs2Name + "]:", function() {
            ...
            var testCases = [   {typeSpecification: null,                   expectedResult: false},
                                ...
                                {typeSpecification: Number,                 expectedResult: true},
                                {typeSpecification: 17,                     expectedResult: false},
                                {typeSpecification: 0,                      expectedResult: false},
                                {typeSpecification: String,                 expectedResult: true},
                                {typeSpecification: "text",                 expectedResult: false},
                                {typeSpecification: Boolean,                expectedResult: true},
                                {typeSpecification: true,                   expectedResult: false},
                                {typeSpecification: false,                  expectedResult: false},
                                {typeSpecification: Array,                  expectedResult: true},
                                {typeSpecification: [],                     expectedResult: false},
                                {typeSpecification: [1, 2, "hello"],        expectedResult: false},
                                {typeSpecification: Function,               expectedResult: true},
                                {typeSpecification: myFunction,             expectedResult: true},
                                {typeSpecification: Object,                 expectedResult: true},
                                {typeSpecification: {},                     expectedResult: false},
                                {typeSpecification: {a: 1},                 expectedResult: false},
                                {typeSpecification: arguejs2.ANYTYPE,       expectedResult: true},
                                {typeSpecification: arguejs2.TAIL,          expectedResult: true},
                                {typeSpecification: MyClass,                expectedResult: true},
                                {typeSpecification: myObject,               expectedResult: false}
                            ];

            it("is a function", function() {
                expect(arguejs2_internals.$.isSimpleMandatoryTypeSpecification).to.be.a("function");
            });
            ...
            function runTestCase(_testCase) {
                ...
                var description =
                        ...
                        " is " + (_testCase.expectedResult ? "" : "not ") + "a simple mandatory type specification";

                it(description, function() {
                    var result = arguejs2_internals.$.isSimpleMandatoryTypeSpecification(_testCase.typeSpecification);
